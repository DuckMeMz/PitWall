...
public static class LapFields
{
    ...
    public static readonly ApiField<ushort> I1Speed = new("i1_speed");
    public static readonly ApiField<ushort> I2Speed = new("i2_speed");
    public static readonly ApiField<ushort> StSpeed = new("st_speed");

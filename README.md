...
> ⚠️ **Known issue:** OpenF1 has just updated the API so races are being rejected due to rejecting large data requests. I’m currently working on buffered loading to resolve this.
